...
1. Install `django-http-api` app from master branch: `pip install git+https://github.com/nmtitov/django-http-api@master` or add `git+https://github.com/nmtitov/django-http-api@master#django-http-api` to your `requirements.txt` file and run `pip install -r requirements.txt`
